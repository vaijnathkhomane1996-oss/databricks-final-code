...
output "workspace_id" {
  ...
  value       = module.dbx_platform.workspace_id
}

output "metastore_id" {
  description = "Unity Catalog metastore ID (shared from staging environment)"
  value       = module.dbx_platform.metastore_id
}

output "cluster_ids" {
  description = "Map of Databricks cluster IDs keyed by cluster key"
