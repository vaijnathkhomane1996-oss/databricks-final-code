variable "workspace_url" {
  type        = string
  description = "Databricks workspace URL (e.g., https://adb-XXXX.cloud.databricks.com)"
}
...
variable "storage_root" {
  type        = string
  description = "Storage root for managed tables in this catalog (e.g., s3://bucket-name/path/)"
}
